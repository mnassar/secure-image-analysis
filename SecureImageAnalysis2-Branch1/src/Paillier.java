...
public class Paillier {
    ...
    public static void main(String[] str) {
        ...
        System.out.println("original product negation: " + prod_m1m2.multiply(new BigInteger("-1")).mod(paillier.n));
        System.out.println("original product: " + prod_m1m2);
        System.out.println("decrypted product: " + (paillier.Decryption(expo_em1m2).abs()).toString());
